...
// The java.util.ArrayList class supports an idea of a dynamic array - an array that grows and shrinks on
// demand to accomodate the number of elements in the array. Below is a list of commonly used methods
//
...
public class DynamicArray<T> implements Iterable<T> {
  ...
  public DynamicArray(int capacity) {
    ...
    // initialize array; cast to type T.
  ...
  public T removeAt(int rm_index) {
    ...
    // copy everything to a new array except that at remove index:
