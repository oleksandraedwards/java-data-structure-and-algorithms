package linkedList;
    ...
    // Linked List - sequential list of nodes that hold data which point to other
    ...
    // singly linked list - only holds reference to the next node. impl: refr head, tail
    // doubly linked list - each node holds reference to next and prev node.
...
public class DoublyLinkedList <T> implements Iterable<T> {
    ...
    public void addFirst(T elem) {
        ...
        // The linked list is empty
        if (isEmpty()) {
            // prev and next pointers set to null
            head = tail = new Node<T>(elem, null, null);
        } else {
